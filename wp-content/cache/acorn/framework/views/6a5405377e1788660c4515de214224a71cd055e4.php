  ...
  <section class="inner">
      <div class="container px-6 py-12 mx-auto">
          <div class="grid grid-cols-1 gap-10 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-3">
              <div class="sm:col-span-2">
                  ...
                  <div class="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
                      ...
                      <button class="mt-10 ml-4 before:ease relative h-12 w-44 overflow-hidden border border-slate-700 text-slate-700  transition-all before:absolute before:top-1/2 before:h-0 before:w-64 before:origin-center before:-translate-x-2 before:rotate-45 before:bg-sunglow before:duration-500 hover:text-white rounded-md hover:before:h-64 hover:before:-translate-y-32 flex items-center justify-center text-xl">
                      <span class="relative z-0 flex justify-center items-center font-barlow">Subscribete 
                        <svg
                          width="28"
                          height="28"
                          viewBox="0 0 24 24"
          ...
          <div class="flex items-center justify-between">
            <a class="brand text-4xl text-slate-700 font-thin  font-barlow" href="<?php echo e(home_url('/')); ?>">
              <?php echo $siteName; ?>
...
<?php /**PATH /Users/macuser/Projects/astra/wp-content/themes/astra/resources/views/sections/footer.blade.php ENDPATH**/ ?>